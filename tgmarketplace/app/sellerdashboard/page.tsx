...
export default function SellerDashboardPage() {
  ...
  return (
    <div>
      ...
      <div className="rounded-[20px] mx-auto max-w-[1200px] w-full overflow-hidden flex gap-4 flex-wrap mt-5 mb-10">
        {products.map((product) => (
          <div
            key={product.id}
            className="dashboardcard bg-base-100 w-96 shadow-xl border-2 border-base rounded-box flex flex-col items-center gap-4 p-4 ml-[2px] shadow-2xl"
          >
