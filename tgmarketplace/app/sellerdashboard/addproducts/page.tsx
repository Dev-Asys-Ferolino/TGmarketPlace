...
//           <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 ml-[-150px] mt-5 border-2 border-red-200 rounded-box">
...
//             ))}
//           </div>
//           <div className="flex justify-center mt-2 border mb-2">
//             <div className="join grid grid-cols-2">
//               <button className="join-item btn btn-xs border-2 border-red-400">Previous page</button>
//               <button className="join-item btn btn-xs border-2 border-red-400">Next</button>
//             </div>
//           </div>
//         </div>
